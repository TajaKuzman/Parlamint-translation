...
def translate_notes(path, lang_code, opus_lang_code, notes_path):
	...
	# Save the df
	df.to_csv("{}".format(notes_path), sep="\t")

	print("The file is saved as {}".format(notes_path))

	return df

df = translate_notes(path, lang_code, opus_lang_code, notes_path)